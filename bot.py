...
GAME_URL = "https://infinitecoin-jumper-2h8s.vercel.app"
...
def send_help_message(chat_id):
    payload = {
        ...
        "text": "📖 *GAME CONTROLS* 📖\n\n"
        "✦ JUMP: Tap ♾️ button\n"
        "✦ DOUBLE JUMP: Double tap ♾️ button\n"
        "✦ COLLECT: ♾️ Infinitecoin coins\n"
        "✦ AVOID: Red (-10% health) | Black (-30% health)\n"
        "✦ GIFT BOX: +10,000 IFC\n"
        "✦ GREEN HEALTH: +50% health\n"
        "✦ DAILY BONUS: +500 IFC every 24h\n\n"
